...
import { LayoutDashboard, Users, FileText, Settings, BarChart, MessageSquare, ChevronLeft, ChevronRight, TrendingUp, GraduationCap } from "lucide-react"
...
export function Sidebar({ className, activePath = "" }: SidebarProps) {
  ...
  const links = [
    ...
    { href: "/expert-personas", label: "Expert Personas", icon: GraduationCap },
