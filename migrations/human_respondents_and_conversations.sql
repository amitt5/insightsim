...
create index human_respondents_simulation_id_idx on human_respondents(simulation_id);
...
create index human_conversations_simulation_id_idx on human_conversations(simulation_id);
