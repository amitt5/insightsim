...
async def retrieve_context(request: RAGQueryRequest):
    ...
    try:
        ...
        # Get context from simple RAG service
        result = await get_simple_rag_service().retrieve_context_simple(
...
async def delete_document(document_id: str, simulation_id: str):
    ...
    try:
        ...
        success = await get_simple_rag_service().delete_document(simulation_id, document_id)
